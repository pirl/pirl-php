...
/**
 * Basic Pirl data types.
 *
 * @see: https://github.com/pirl/wiki/wiki/Pirl-Contract-ABI#types
 */
class PirlDataTypePrimitive extends PirlDataType {
  ...
  const MAP = array(
    ...
    // 40 hex characters, 160 bits. E.g Pirl Address.
    'D20' => 'PirlD20',
  ...
  public function getType($schema = FALSE) {
    ...
    if (substr($class_name, 0, strlen(__NAMESPACE__)) === __NAMESPACE__) {
      // Cut of namespace and Slash. E.g "Pirl\".
