...
/**
 * Static helper functions for Pirl JsonRPC API for PHP.
 */
class PirlStatic {
   ...
   *   See: https://github.com/pirl/wiki/wiki/Pirl-Contract-ABI.
   *
   * @return bool
   ...
   *
   * See:
   * https://github.com/pirl/wiki/wiki/JSON-RPC#hex-value-encoding.
   *
  ...
  public static function isValidHexQuantity($str) {
    ...
    if (!PirlStatic::hasHexPrefix($str)) {
      return FALSE;
    }
  ...
  /**
   * Check for a valid Pirl address.
   *
   * Tests if the given string qualifies as a Pirl address.
