 ...
 */
class CallTransaction extends PirlDataType {
   ...
   * Constructor.
   */
  public function __construct(PirlD20 $to, PirlD20 $from = NULL, PirlQ $gas = NULL, PirlQ $gasPrice = NULL, PirlQ $value = NULL, PirlD $data = NULL, PirlQ $nonce = NULL) {
    $this->to = $to;  
    $this->from = $from;  
    $this->gas = $gas;  
