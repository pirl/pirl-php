...
class PirlQ extends PirlD {
  ...
  // See:https://github.com/pirl/wiki/wiki/RLP
  const HEXPADDING = 64;
  ...
  protected function getAbiFromNumber(Math_BigInteger $number) {
    ...
    foreach ($this->getValidLengths() as $exp) {
      ...
      // Prevent overflow See: http://pirl.stackexchange.com/a/7294/852.
  ...
  public function hexVal() {
    ...
    // Pirl requires two's complement.
